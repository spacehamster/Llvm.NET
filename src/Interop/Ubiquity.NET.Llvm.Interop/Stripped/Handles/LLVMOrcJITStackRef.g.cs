...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcJITStackRef
        : LlvmObjectRef
    {
        /// <summary>Creates a new instance of an LLVMOrcJITStackRef</summary>
        ...
        public static LLVMOrcJITStackRef Zero { get; } = new LLVMOrcJITStackRef(IntPtr.Zero, false);
        ...
        protected override bool ReleaseHandle( )
        {
            ...
            {
                LLVMOrcDisposeInstance( prevHandle );
            }
            return true;
        }
